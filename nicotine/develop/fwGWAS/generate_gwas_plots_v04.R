...
manhattanOddChrColor = "blue"
manhattanEvenChrColor = "red"
manhattanHighlightColor = "green"
...
chiDf=1
qqLambda = FALSE
sigThreshold = -log10(as.double(5e-08)) # negative log
plotTitle = ""
...
while (loop) {
	...
	if (args[1] == "--sig_threshold") {
		num = as.double(args[2])
		sigThreshold = -log10(num)
	}
